...
const ToolArsenalDiscovery = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Tool Discovery - OffSec Radar | Security Tools from GitHub</title>
        <meta name="description" content="Discover security tools from GitHub's ecosystem. Filter by category, language, and features. Open-source tool discovery platform." />
        <meta name="keywords" content="security tools, GitHub, penetration testing, red team, blue team, OSINT, malware research" />
        <meta property="og:title" content="Tool Discovery - OffSec Radar" />
        <meta property="og:description" content="Discover security tools from GitHub's ecosystem. Open-source platform." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="/tool-arsenal-discovery" />
      </Helmet>
